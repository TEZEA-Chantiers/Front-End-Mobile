          ...
          title: StreamBuilder(
                  ...
                  builder: (context, snapshot) {
                    ...
                    switch(snapshot.data['statusChantier'].toString()) {
                      case 'Demarre' : {statusColor = Colors.green;}
                      break;

                      case 'enCours': {statusColor = Colors.green;}
                      break;

                      case 'enAttente': {statusColor = Colors.deepOrange;}
                      break;

                      case 'Termine': {statusColor = Colors.grey;}
                      break;
